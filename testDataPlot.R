...
testNamesOveride = c("T11.4B","T11.4C")
summaryStatsRound = 1
setAbline = T
ablineMin = -100
ablineMax = 100
...
boxplot(testData,main=boxplotMain,notch=T,varwidth=T,col="lightblue",outpch=1,outcex=1.5)
grid(nx=NA,ny=NULL)
stripchart(testData,vertical=T,method="jitter",jitter=0.25,pch=21,cex=1.25,col="maroon",bg="bisque",add=T) 
if (setAbline) {
